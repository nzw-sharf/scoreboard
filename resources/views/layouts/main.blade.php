...
<body class="bg-black text-white flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6">
           @yield('content')
        </main>
    </div>
    <div class="flex flex-col item-center justify-center mt-8">
        <div class="flex item-center justify-center">
            <div class="me-8 mb-4">
                <a href="{{route('scoreSummary')}}" class="bg-yellow-500 text-white text-sm py-2 px-4 rounded-lg hover:bg-yellow-500 transition-all">
            Category Score Summary
        </a>
            </div>
            <div>
                <a href="{{route('report')}}" class="bg-yellow-500 text-white text-sm py-2 px-4 rounded-lg hover:bg-yellow-500 transition-all">
            Item Wise Result
        </a>
            </div>
        </div>
